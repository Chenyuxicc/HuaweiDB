...
public class EngineKVStoreRaceExample implements KVStoreRace {
	...
	private static final int COMMIT_TIMES = 4;
	...
	public boolean init(final String dir, final int thread_num) throws KVSException {
		...
		this.dir = dir + File.separator + BufferUtil.fillThreadNo(this.thread_num);		
		...
		try {
			dataManager.init(this.dir, this.file_size);
			metaDataManager.init(this.dir);
		} catch (IOException e) {
